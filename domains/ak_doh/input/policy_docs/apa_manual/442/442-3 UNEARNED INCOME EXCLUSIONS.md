...
Any increase in the value of an excluded burial fund, or the excluded portion of a burial fund, because of interest accumulation or appreciation is excluded as income. (Refer to section [432-2D](<http://dpaweb.hss.state.ak.us/manuals/432/432-2_personal_property.htm#432-2_D._BURIAL_FUND_EXCLUSION>).)
