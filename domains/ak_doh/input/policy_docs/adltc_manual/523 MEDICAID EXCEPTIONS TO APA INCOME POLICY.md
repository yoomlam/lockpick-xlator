*Source: http://dpaweb.hss.state.ak.us/manuals/apa/html/523_medicaid_exceptions_to_apa_income_policy.htm*


Page title: [523 MEDICAID EXCEPTIONS TO APA INCOME POLICY](http://dpaweb.hss.state.ak.us/manuals/apa/html/523_medicaid_exceptions_to_apa_income_policy.htm)
...
Increases in Social Security retirement, survivors, and disability insurance benefits and SSASocial Security Administration COLAs are disregarded for certain **grandfathered** individuals. See sections [531](<http://dpaweb.hss.state.ak.us/manuals/531_deemed_an_ssi_apa_recipient_under_the_pickle_amendment/531_deemed_under_the_pickle.htm>) and [540](<http://dpaweb.hss.state.ak.us/manuals/540_grandfathered_eligibility_categories/540_grandfathered_eligibility_categories.htm>).
...
To be considered reasonably compatible, income electronically reported by Department of Labor (DOL) must be within 10% of the client stated gross monthly income. The most recent quarter reported by DOLDepartment of Labor and Workforce Development is divided by three to get the average monthly income amount.

Note: 
 
Apply the Income Exclusions listed in [APA MS 442](<http://dpaweb.hss.state.ak.us/manuals/apa/442/442_income_exclusions.htm>) before comparing the client's statement of earnings and DOLDepartment of Labor and Workforce Development electronic verification. 
 
The verification code will need to be "interface" for client statement. 
 
Actual income information must be used for the cost of care calculation described in section [570](<http://dpaweb.hss.state.ak.us/manuals/570_post_eligibility_treatment_of_income_\(coca\)/570_post_eligibility_and_coc.htm>) and Working Disabled Medicaid cases.
...
[MC #70 (12/25)](<http://dpaweb.hss.state.ak.us/manuals/mc__70_\(12_25\).htm>)
