...
**Scope note:** This is a Claude authoring cheat sheet, not a replacement for `core/CIVIL_DSL_spec.md`. It covers only the model types needed to write a CIVIL module. Add a note at the top pointing to the full spec for design rationale.

**Sections:**
1. Header with last-verified datestamp + link to `core/CIVIL_DSL_spec.md` for full spec
...
- [ ] `tools/civil_schema.py` has a sync comment pointing to both `docs/civil-quickref.md` and `core/CIVIL_DSL_spec.md`
- [ ] `docs/civil-quickref.md` exists with last-verified datestamp `2026-02-25` and link to `core/CIVIL_DSL_spec.md`
